...
if __name__ == "__main__":
    ...
    # parser.add_argument("--config", type=str, default='configs/cifar-100/seed-1029/single/vgg13.yml')
    # parser.add_argument("--logdir", type=str, default='run/cifar-100/seed-1029/single/vgg13')
    # parser.add_argument("--file_name_cfg", type=str, default='kd-vgg13-cifar-100')

    parser.add_argument("--config", type=str, default='configs/tiny-imagenet/seed-1029/single/vgg13.yml')
    parser.add_argument("--logdir", type=str, default='run/tiny-imagenet/seed-1029/single/vgg13')
    parser.add_argument("--file_name_cfg", type=str, default='kd-vgg13-tiny-imagenet')
